...
describe('Download Products', function() {
    ...
    describe('properties', function() {
        ...
        it('should update data attribute', function() {
            var data = 'http://www.testproduct.com/';
            wc.data = data;
            expect(wc.getAttribute('data')).toEqual(data);
        });
    ...
    describe('with valid data', function() {
        ...
        it('should be contain a valid download link and version name', function() {
            wc.data = mockData;
            expect(wc.products).toEqual({"products":[{"productName":"Red Hat JBoss Data Virtualization","groupHeading":"INTEGRATION AND AUTOMATION","productCode":"datavirt","featured":false,"downloadLink":"https://developers.stage.redhat.com/download-manager/content/origin/files/sha256/b4/b466affbcc1740bf2c7c73b60bb6ffa7e1ec844fc08447224ab15aa3bcee3949/jboss-dv-6.3.0-1-installer.jar","description":"A tool that brings operational and analytical insight from data dispersed in various business units, apps, and technologies.","version":"6.3.0","learnMoreLink":"https://developers.redhat.com/products/datavirt/overview/"}]});
        });

        it('should return a list by category when requested', function() {
            var categoryList = wc.getProductsWithHeading(heading)
            expect(categoryList).toEqual(categoryList);
        });
